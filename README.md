...
- `public/manifest.json`, `public/sw.js`, `public/favicon.svg`, and the app icons `public/icon-192.png` / `public/icon-512.png` are included.
- Icons are generated by `scripts/generate-icons.mjs` (dependency-free Node script rendering the brand mark). Re-run `node scripts/generate-icons.mjs` if the brand colors change.
...
- Skeleton loading: available on every page
- PWA icons: generated (192/512, maskable) via `npm run icons`
